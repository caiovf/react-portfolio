...
export const Button = (props) => {
    ...
    const imageSrc = props.iconSrc ? `/assets/img/icons/${props.iconSrc}` : null;
    ...
    const handleClick = (e) => {
        if (props.navigate) {
            e.preventDefault();
            // Ensure navigate is a string and not empty
            if (typeof props.navigate === 'string' && props.navigate.length > 0) {
