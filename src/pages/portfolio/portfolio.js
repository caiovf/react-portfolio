...
export const Portfolio = (props) => {
  ...
  const portfolioData = (location.pathname === '/advancing-skills') ? state.projectsData.study : state.projectsData.portfolio ;  
  const pageTitle = (location.pathname === '/advancing-skills') ? 'Advancing my Skills' : "Portfolio" ;  
  const pageResumn = (location.pathname === '/advancing-skills') ? 'Explore my portfolio to discover projects that highlight my continuous learning and skills development, featuring React, WordPress, and more.' : "Explore my work to see a range of projects utilizing HTML, CSS, JavaScript, jQuery, PHP, and WordPress. <a href='https://www.linkedin.com/in/caio-ferreiradev/' target='_blank' rel='nofollow noopener noreferrer'>Let's build something amazing together!</a>";
